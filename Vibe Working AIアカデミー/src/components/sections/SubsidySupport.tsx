      ...
      <div className="container-custom">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">申請書類作成代行</div>
                        <div className="text-sm text-gray-600">複雑な申請書類を専門スタッフが代行作成</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">受給確率95%以上</div>
                        <div className="text-sm text-gray-600">豊富な実績による高い受給率を実現</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">成果報告まで完全サポート</div>
                        <div className="text-sm text-gray-600">受給まで責任を持って伴走いたします</div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">あなたの会社で実際にどれくらいの助成金が受給できるかシミュレーション</p>
          </div>
